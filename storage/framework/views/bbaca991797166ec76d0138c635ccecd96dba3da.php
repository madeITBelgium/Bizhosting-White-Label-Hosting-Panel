    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col col-md-6 d-flex justify-content-end">
                <button class="btn btn-primary mr-3" wire:click="$toggle('checkDomainname')"><?php echo e(__('Check')); ?></a>
                <button class="btn btn-primary" wire:click="$toggle('addItem')">+ <?php echo e(__('Domainname')); ?></a>
            </div>
                    ...
                    <?php if($domainnames->count()): ?>
                        <table class="table">
                            ...
                            <?php $__currentLoopData = $domainnames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><a href="<?php echo e(route('hosting.admin.domainname.show', $item)); ?>"><?php echo e($item->id); ?></a></td>
                                    <td><a href="<?php echo e(route('hosting.admin.domainname.show', $item)); ?>"><?php echo e($item->domainname); ?></a></td>
                                    <td><?php echo e(optional($item->team)->name ?? '/'); ?></td>
...
<?php endif; ?>
            ...
            <div class="mt-4">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.label','data' => ['for' => 'authToken','value' => ''.e(__('Auth Token')).'']]); ?>
<?php $component->withName('jet-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['for' => 'authToken','value' => ''.e(__('Auth Token')).'']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['type' => 'text','class' => ''.e($errors->has('authToken') ? 'is-invalid' : '').'','placeholder' => ''.e(__('Auth Token')).'','wire:model.defer' => 'authToken']]); ?>
<?php $component->withName('jet-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'text','class' => ''.e($errors->has('authToken') ? 'is-invalid' : '').'','placeholder' => ''.e(__('Auth Token')).'','wire:model.defer' => 'authToken']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
</div><?php /**PATH /var/www/html/hosting/src/ServiceProvider/../../resources/views/admin/livewire/domainname/index.blade.php ENDPATH**/ ?>