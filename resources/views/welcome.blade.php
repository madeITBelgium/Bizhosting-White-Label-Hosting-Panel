            ...
            <div class="col-sm-4">
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        <p class="text-center">
                            <a href="{{ route('home.webhosting') }}" class="btn btn-primary">Meer info</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        <p class="text-center">
                            <a href="{{ route('home.contact') }}" class="btn btn-primary">Meer info</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-5">
            <div class="pricing-tables attached">
                ...
                <div class="row mt-3 mb-4">
                    ...
                    @foreach(collect(config('hosting.hosting_packages'))->where('public', true)->all() as $hostingPackage)
                        <div class="col-sm-3">
                            <div class="plan">
                                <div class="head">
