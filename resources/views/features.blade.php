            ...
            <div class="col-sm-4">
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        <p>Domeinnamen zijn maar 1 jaar geldig, je moet het dus elk jaar opnieuw verlengen. Door onze voordelige prijzen doe je dat met plezier, een kleine investering die zeer veel kan opbrengen. Dat vanaf €{{ number_format(\MadeITBelgium\Hosting\Models\Topleveldomain::min('sell_price'), 2, ",", "") }} incl. BTW per jaar.</p> 
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
